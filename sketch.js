...
function spawnDoors()
 {
  ...
  if (frameCount % 240 === 0) {
    var doorsGroup = createSprite(200, -50);
    var climbersGroup = createSprite(200,10);
    var invisibleBlockGroup = createSprite(200,15);
    invisibleBlockGroup.width = climbersGroup.width;
